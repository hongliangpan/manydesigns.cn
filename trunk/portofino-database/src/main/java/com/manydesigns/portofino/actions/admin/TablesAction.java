...
public class TablesAction extends AbstractActionBean {
    ...
    protected final Map<String, String> fkOnePropertyNames = new TreeMap<String, String>();
    protected final Map<String, String> fkManyPropertyNames = new TreeMap<String, String>();
