...
public class CrudAction extends AbstractCrudAction<Object> {
	...
	public static final String[][] CRUD_CONFIGURATION_FIELDS = { { "name", "database", "query", "searchTitle",
			"createTitle", "readTitle", "editTitle", "variable", "largeResultSet", "rowsPerPage" } };
	...
	protected String generateCountQuery(String queryString) throws JSQLParserException {
		...
		try {
			PlainSelect plainSelect = (PlainSelect) ((Select) parserManager.parse(new StringReader(queryString)))
					.getSelectBody();
	...
	protected void prepareConfigurationForms() {
		...
		crudConfigurationForm = new FormBuilder(CrudConfiguration.class).configFields(CRUD_CONFIGURATION_FIELDS)
				.configFieldSetNames("Crud").configSelectionProvider(databaseSelectionProvider, "database").build();
	...
	public void loadObjects() {
		...
		try {
			...
			objects = QueryUtils.getObjects(session, crudConfiguration.getQuery(), criteria, this, firstResult,
					maxResults);
