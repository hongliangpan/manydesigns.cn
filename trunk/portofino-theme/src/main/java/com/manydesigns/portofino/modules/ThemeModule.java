...
public class ThemeModule implements Module {
	...
	public void init() {
		...
		// 横向layout支持两列
		templates.register("column2-layout");
		// 横向layout支持三列
		templates.register("column3-layout");
		// 横向layout支持四列
		templates.register("column4-layout");
		templates.register("column5-layout");
		templates.register("column6-layout");
		// 通过参数判断是否嵌入式页面
		templates.register("default-is-embedded");

		// 没有left和foot
		templates.register("default-only-center");
