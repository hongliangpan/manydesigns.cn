...
%><%@ page import="com.manydesigns.elements.text.OgnlTextFormat"
%>
    ...
    <stripes:layout-component name="pageBody">
        <stripes:form action="${actionBean.context.actionPath}" method="post" enctype="multipart/form-data"
            ...
            <%
                ...
                // superpan test add manyToMany /m/many2many/checkboxes.jsp
            	String formatString = String.format("%%{%s}", "c_name");
                ...
                for(Map.Entry<Object, Boolean> entry : actionBean.getBooleanRelation().entrySet()) {
                    ...
                    //superpan modify
                    String t_shortName =ognlTextFormat.format(obj);
                    buffer.write(t_shortName);
