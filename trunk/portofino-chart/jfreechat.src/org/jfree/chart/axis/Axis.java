 ...
 * 30-Nov-2001 : Changed default font from "Arial" --> JFreeChart.getFont() (DG);
...
public abstract class Axis implements Cloneable, Serializable {
    ...
    public static final Font DEFAULT_AXIS_LABEL_FONT = new Font(
            JFreeChart.getFont(), Font.PLAIN, 12);
    ...
    public static final Font DEFAULT_TICK_LABEL_FONT = new Font(JFreeChart.getFont(),
            Font.PLAIN, 10);
