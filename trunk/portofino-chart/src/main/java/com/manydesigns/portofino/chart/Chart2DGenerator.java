...
public abstract class Chart2DGenerator extends AbstractChartGenerator {
	...
	// Other objects
	// **************************************************************************
	protected final Font titleFont = new Font(ChartConfiguration.getFont(), Font.BOLD, 12);
	protected final Font axisFont = new Font(ChartConfiguration.getFont(), Font.PLAIN, 12);
	protected final Font legendFont = new Font(ChartConfiguration.getFont(), Font.BOLD, 10);
	protected final Font legendItemFont = new Font(ChartConfiguration.getFont(), Font.PLAIN, 10);
	...
	protected abstract JFreeChart createChart(ChartDefinition chartDefinition, CategoryDataset dataset,
