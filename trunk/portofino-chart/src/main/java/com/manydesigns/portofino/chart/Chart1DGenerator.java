...
public abstract class Chart1DGenerator extends AbstractChartGenerator {
	...
	// Other objects
	// **************************************************************************
	private final Font titleFont = new Font(ChartConfiguration.getFont(), Font.BOLD, 12);
	private final Font legendFont = new Font(ChartConfiguration.getFont(), Font.BOLD, 10);
	private final Font legendItemFont = new Font(ChartConfiguration.getFont(), Font.PLAIN, 10);
