...
public class JdbcConnectionProviderTemp extends JdbcConnectionProvider {
	...
	public JdbcConnectionProviderTemp() {
		super();
	}
	...
	public String getDescription() {
		return MessageFormat.format("JDBC connection to URL: {0}", url);
	}

	public Connection acquireConnection() throws Exception {
		Class.forName(driver);
		return DriverManager.getConnection(actualUrl, username, password);
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("driver", driver).append("url", url).append("username", username)
