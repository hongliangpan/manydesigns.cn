...
package com.manydesigns.portofino.report;
...
public class Templates {
	...
	static {
		...
		HyperLinkBuilder link = hyperLink("http://www.ruijie.com.cn");
		dynamicReportsComponent = cmp.horizontalList(
				cmp.image(Templates.class.getResource("images/company.png")).setFixedDimension(60, 60),
				cmp.verticalList(
						cmp.text("Riil报表").setStyle(bold22CenteredStyle)
								.setHorizontalAlignment(HorizontalAlignment.LEFT), cmp.text("http://www.ruijie.com.cn")
