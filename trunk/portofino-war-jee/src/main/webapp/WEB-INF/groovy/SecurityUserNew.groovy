...
public class SecurityUserNew extends AbstractPortofinoRealm {

    public static final Logger logger = LoggerFactory.getLogger(Security.class);

    protected String databaseName = "riil_its_board";

    protected String userTableEntityName = "t_admin_user";
    ...
    protected String groupTableEntityName = "t_admin_group";
    protected String groupIdProperty = "c_id";
    protected String groupNameProperty = "c_name";

    protected String userGroupTableEntityName = "t_admin_group_user_rel";
    ...
    protected Collection<String> loadAuthorizationInfo(Serializable principal) {
        ...
        if(StringUtils.isEmpty(userGroupTableEntityName) || StringUtils.isEmpty(groupTableEntityName)) {
            ...
            def queryString = """
                ...
                from t_admin_group g, t_admin_group_user_rel ug, t_admin_user u
    ...
    void changePassword(Serializable user, String oldPassword, String newPassword) {
        ...
        def q = session.createQuery("""
                update t_admin_user set c_password = :newPwd
                where c_id = :id and c_password = :oldPwd""");
    ...
    String encryptPassword(String password) {
        return this.plaintext(password);
    }
    ...
    Map<Serializable, String> getUsers() {
        ...
        Query query = session.createQuery(
                "select c_id, c_name from t_admin_user order by c_name");
