...
public class Security extends AbstractPortofinoRealm {
    ...
    protected String userTableEntityName = "t_sys_user";
    ...
    protected String groupTableEntityName = "t_sys_group";
    protected String groupIdProperty = "c_id";
    protected String groupNameProperty = "c_name";

    protected String userGroupTableEntityName = "t_sys_group_user_rel";
    ...
    protected Collection<String> loadAuthorizationInfo(Serializable principal) {
        ...
        if(StringUtils.isEmpty(userGroupTableEntityName) || StringUtils.isEmpty(groupTableEntityName)) {
            ...
            def queryString = """
                ...
                from t_sys_group g, t_sys_group_user_rel ug, t_sys_user u
    ...
    void changePassword(Serializable user, String oldPassword, String newPassword) {
        ...
        def q = session.createQuery("""
                update t_sys_user set c_password = :newPwd
    ...
    String encryptPassword(String password) {
        return this.md5Base64(password);
    }
    ...
    Map<Serializable, String> getUsers() {
        ...
        Query query = session.createQuery(
                "select c_id, c_name from t_sys_user order by c_name");
