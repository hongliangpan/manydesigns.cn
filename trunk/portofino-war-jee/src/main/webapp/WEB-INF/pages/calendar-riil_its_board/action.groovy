...
class CalendarPage extends CalendarAction {
    ...
    def calDefs = [["t customer", "riil_its_board.itsboard200.t_customer", ["c_warranty_end"], new java.awt.Color(255, 0, 0)], ["t project", "riil_its_board.itsboard200.t_project", ["c_order_time", "c_begin_date", "c_end_date"], new java.awt.Color(64, 128, 255)]]; //Es. [["Cal 1", "db1.schema1.table1", ["column1", "column2"], Color.RED], ["Cal 2", "db1.schema1.table2", ["column1", "column2"], Color.BLUE]]
