...
class MyCustomAction extends CustomAction {
    ...
    //Automatically generated on Thu Dec 12 15:04:39 CST 2013 by ManyDesigns Portofino
    //Write your code here

    @DefaultHandler
    public Resolution execute() {
        String fwd = "/custom/region_select.jsp?pageId=data_warranty&width=1000&height=400";
