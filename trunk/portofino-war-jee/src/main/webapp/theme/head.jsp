...
<![endif]-->
<link rel="stylesheet" type="text/css" href="<stripes:url value='/theme/bootstrap/css/bootstrap.css' />">
<!--yujun add -->
<link rel="stylesheet" type="text/css" href="<stripes:url value='/theme/portofino.css' />">
<%-- <link rel="stylesheet" type="text/css" href="<stripes:url value='/theme/bootstrap_30/css/bootstrap-theme.css' />"> --%>
...
<link type="text/css" rel="stylesheet" href="<stripes:url value="/m/openid/openid-selector/css/openid.css" />" />
	...
	<!-- asset echarts java script import -->
